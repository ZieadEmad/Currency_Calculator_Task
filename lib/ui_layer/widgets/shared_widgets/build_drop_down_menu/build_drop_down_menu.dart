...
class _BuildDropDownMenuState extends State<BuildDropDownMenu> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GetAllCurrenciesCubit, GetAllCurrenciesStates>(
        ...
        if (state is GetAllCurrenciesSuccess) {
          return DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              value: startValue,
              onChanged: (newValue) {
                var cubit = GetAllCurrenciesCubit.get(context);
                cubit.choosenCode = cubit.allCurrencies.keys.firstWhere(
                    (element) => cubit.allCurrencies[element] == newValue);
                setState(() {
                  startValue = newValue;
                });
              },
